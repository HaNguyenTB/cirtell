...
\usetikzlibrary{positioning,arrows.meta,shapes.geometric,shapes.symbols,fit,calc,backgrounds,decorations.pathreplacing}
\graphicspath{{./images/}{./assets/}} % Khai báo thư mục chứa ảnh
\newcommand{\diagramfigure}[4][1]{%
  \begin{figure}[H]
    \centering
...
% Cho phép xuống dòng tại dấu gạch dưới và dấu chấm trong văn bản kỹ thuật
\usepackage{seqsplit}
\usepackage{float}
% Tránh chữ tràn ra ngoài lề
\sloppy
...
\usepackage{xltabular} % Gói quan trọng: Kết hợp longtable và tabularx
\usepackage{enumitem}  % Để định dạng danh sách đẹp hơn
\usepackage{geometry}
